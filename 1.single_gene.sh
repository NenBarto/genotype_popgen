...
for file in ${files[@]}; do 
  ...
  haplotypecaller_line="singularity exec --bind $bwaDir:/bwaDir,$haplotypesDir:/haplotypesDir,$annotationDir:/annotationDir $GATKimage gatk --java-options "-Xmx4G" HaplotypeCaller -R /annotationDir/$REFERENCE -I /bwaDir/$sortedBamFile -O /haplotypesDir/$haplotypeFile -ERC GVCF"
