...
#or what has the largest influence on the data
#build a script to test all the parameters
#find a paper with GATK, vcf and parameters
...
#allow Andrew to test which most important

#transfer to nextflow, to Amazon
